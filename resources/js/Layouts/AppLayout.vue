            ...
            <nav class="bg-white border-b border-gray-100">
                <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-20">
                        ...
                        <button
                            v-if="jetstream && jetstream.managesProfilePhotos"
                        ...
                        >
                            <div
                                class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-950"
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="../../js/Components/TICKET.IO (2).png"
                                        class="h-40 me-40 sm:h-40"
                                        alt="logo"
                                    />
                                    <span
                                ...
                                <ul class="space-y-2 font-medium">
                                    ...
                                    <li>
                                        ...
                                        >
                                            ...
                                            <Link
                                                class="flex-1 ms-3 whitespace-nowrap cursor-pointer"
